...
- [ ] 1) Initiate your repository:
    ...
    - [ ] update any repository settings, below are my recommended settings:
        ...
        - [ ] protect the main branch so any changes to it need to be made through a Pull Request.
            - go to the repository's `Settings`, `Branches`, `Add branch ruleset`.
              - [ ] Name it "protected_main"
              - [ ] make the `Enforcement status` Active
              - [ ] include the Default branch as the target
              - [ ] check the following `Rules`:
                - [ ] `Restrict deletion`
                - [ ] `Require a pull request before merging`
                - [ ] only allow `Squash` as a merge method
                - [ ] `Block force pushes`
